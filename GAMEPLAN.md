...
**Visual direction:** a precise instrument panel with warm character. Use deep brown-black surfaces, warm ivory text, restrained amber accents, clear state labels, and legible monospace data. The tree and pages are the main stage; operation controls and the timeline provide context. Start with SVG for inspectable geometry. Keep page identities stable as layouts change, and make transitions explain cause and effect. Support keyboard operation, reduced motion, and a readable narrow-screen replay.
