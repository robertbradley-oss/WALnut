...
[![A committed page split: the operation bar names the generation change and the new root, the B+ tree shows one leaf becoming two, and the durability rail shows the log holding one transaction the main file does not have](docs/media/walnut-demo.png?v=bd572a6)](https://robertbradley-oss.github.io/WALnut/walnut-demo.webm?v=bd572a6)

**[Explore the browser demo](https://robertbradley-oss.github.io/WALnut/?v=bd572a6)** · [Watch the 30-second recording](https://robertbradley-oss.github.io/WALnut/walnut-demo.webm?v=bd572a6) · [Engineering case study](docs/case-study.md) · [Measured performance](docs/performance.md)
...
![The live workbench after a point lookup: the page map, tree, search path, record list and byte layout all highlight the same key](docs/media/walnut-live.png?v=bd572a6)
...
**Just explore:** [open the current browser demo](https://robertbradley-oss.github.io/WALnut/?v=bd572a6). It includes the updated interface and three real engine recordings. The demo is recorded exploration; running the engine locally lets you write your own data.
