...
- Use `docs/tree-contract.md` for the phase 3 tree, transaction, and recovery invariants. Preserve the historical phase 1/2 reports and legacy migration tests.
